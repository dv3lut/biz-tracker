...
class SyncCollectorMixin(SyncPersistenceMixin):
    ...
    def _collect_google_only(self, context: SyncContext) -> SyncResult:
        ...
        targets = self._load_google_resync_targets(session, mode, context.target_naf_codes)
        ...
        alert_service = (
            AlertService(session, run, client_notifications_enabled=context.client_notifications_enabled)
    ...
    def _load_google_resync_targets(
        self,
        session,
        mode: SyncMode,
