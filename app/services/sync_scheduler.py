    ...
    *,
    ...
    retryable_condition = or_(
        ...
        and_(
            ...
            models.SyncRun.mode == DEFAULT_SYNC_MODE.value,
            models.SyncRun.created_records == 0,
            models.SyncRun.updated_records == 0,
        ),
    )
...
class SyncScheduler:
    ...
    def _tick(self) -> None:
        ...
        retry_limit = self._service.settings.sync.auto_retry_max_attempts
