...
from app.api.routers.admin import clients
...
class ClientRouterDelegationTests(TestCase):
    ...
    @patch("app.api.routers.admin.clients.list_clients_action")
    ...
    @patch("app.api.routers.admin.clients.get_client_action")
    ...
    @patch("app.api.routers.admin.clients.create_client_action")
    ...
    @patch("app.api.routers.admin.clients.update_client_action")
    ...
    @patch("app.api.routers.admin.clients.delete_client_action")
